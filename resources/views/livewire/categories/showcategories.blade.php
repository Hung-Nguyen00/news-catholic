<div>
    ...
    <div class="card-header">
        ...
        <button data-toggle="modal"
                ...
                class="btn btn-primary btn-sm">Tạo mới menu chính</button>
    </div>
    <div class="card-body">
                        ...
                        <div class="alert alert-dark d-flex">
                            ...
                            <div class="col-md-4" style="text-align: end" >
                                <button data-toggle="modal"
                                        ...
                                        class="btn btn-sm btn-info">Sửa</button>
                                <button data-toggle="modal"
                                        data-target="#createChildModal"
                                        wire:click="editChild({{ $category->id }})"
                                        class="btn  btn-sm btn-info">Thêm menu con</button>
                                <button data-toggle="modal"
