                                              ...
                                              <div class="row">
                                                  <div class="col-xl-12 col-lg-8 col-sm-12">
                                                    ...
                                                    <p class="fs-13 text-muted">
                                                        <span class="mr-2">Hình ảnh </span>{{ \Carbon\Carbon::parse($post->created_at)->diffForHumans() }}
                                                    </p>
                                                    <p class="fs-15">
                                                        {{strlen($post->short_description) > 120 ? substr($post->short_description,0, 120)."..." : $post->short_description  }}
                                                    </p>
                                                    <a href="#" class="font-weight-600 fs-16"
                                                    >Read more</a
                                                    >
                                                </div>
                                              </div>
                        ...
                        <div class="col-12 col-md-12 col-lg-5">
                            <div class="card-title">
                               Các bài viết liên quan
                                <span class="float-right"><a href="" class="fs-15">Xem tất cả</a></span>
                            </div>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-7 ">
                                                                <p class="fs-16 font-weight-600 mb-0">
                                                                    <a href="" class="fs-16"> {{ $post->title }}</a>
                                                                </p>
